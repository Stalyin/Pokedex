    ...
    <section className="container-ft">
      <header className='banner'>
        ...
        <div className='banner-img2'>
          <img className='banner-img' src="/public/banner.png" alt="Banner" />
        </div>
      </header>
      ...
      <footer className="footer">
        <div className='footer-logo'>
          <img src="/public/pokemons.png" alt="Pokemons" />
        </div>
        ...
        <img className='mobile-footer' src="/public/banner.png" alt="Mobile Footer" />
      </footer>
    </section>
  );
}
