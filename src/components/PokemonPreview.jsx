...
const PokemonPreview = ({ pokemonURL, onClick }) => {
  ...
  return (
    <article
      ...
      className="cards-pokemon text-center rounded-[30px] relative font-semibold capitalize pb-4 shadow-lg shadow-slate-400/10 border-2 border-transparent hover:border-slate-200 cursor-pointer group grid gap-2"
    >
      ...
      <span className="text-sm text-slate-200">N° {pokemon?.id}</span>
